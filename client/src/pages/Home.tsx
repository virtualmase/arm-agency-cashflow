  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 lg:px-12 h-[60px] bg-[#080a08]/85 backdrop-blur-xl border-b border-white/[0.07]">
      ...
      <div className="flex items-center gap-6">
        ...
        <Link href="/insights" className="text-[12px] tracking-[0.08em] uppercase text-[#667066] hover:text-[#e8a020] transition-colors no-underline hidden md:inline">Guides</Link>
